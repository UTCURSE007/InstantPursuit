...
const NAV_LINKS = [{"href":"index.html","label":"Home","icon":"🏠"},{"href":"explore.html","label":"Explore","icon":"🗺️"},{"href":"blog.html","label":"Blog","icon":"✍️"},{"href":"about.html","label":"About","icon":"📖"}];
function getThemegetTheme(){return localStorage.getItem('ip-theme')||'dark'}
...
const DEFAULT_BLOG_DATA = [
  ...
  },
  {
    ...
    "furtherReads": [
      {
        "title": "NEET vs JEE — Difficulty, Career & Lifestyle Compared",
        "url": "https://www.youtube.com/watch?v=xPVpq3SKXhM"
      },
      {
        "title": "NTA Official — JEE Main",
        "url": "https://jeemain.nta.nic.in"
      },
      {
        "title": "NTA Official — NEET UG",
        "url": "https://neet.nta.nic.in"
      }
    ]
  }
